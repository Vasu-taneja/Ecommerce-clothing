  ...
  <div id="app" class="container">
    <main>
      <nav class="navbar navbar-expand-lg navbar-light" id="nav">
        <img alt="MEN FORM LOGO" src="./assets/logo.png" width="100px" />
        <button
    ...
    <footer class="container-fluid footer text-left mt-3">
      <p class="mr-auto">
        Developed by:
        <strong>Team MSSV</strong>
      </p>
      <div style="float: right">
        <a href="mailto:vtaneja76@gmail.com" style="margin-right: 10px">
          <i
        ...
        <a
          href="https://github.com/vasu-taneja"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/vataneja/"
          target="_blank"
          style="margin-right: 10px"
        >
          <i
...
/* Banner style*/
.jumbotron-fluid {
  background: lightblue url("./assets/banner.jpg") no-repeat center;
